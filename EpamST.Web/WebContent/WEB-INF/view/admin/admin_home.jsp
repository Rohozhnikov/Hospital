...
<body class="home">
	<!-- Fixed navbar -->
	<jsp:include page="/WEB-INF/view/admin/admin_header.jsp" />
	<br><br>	<br>	<br>	<br>	<br>
	<!-- /.navbar -->
		...
		<div class="container">
			...
			<div class="row">
				<div class="col-md-3 col-sm-6 highlight">
					<div class="h-caption">
						<h4>
							<i class="fa fa-cogs fa-5"></i>Users
						</h4>
					</div>
				...
				<div class="col-md-3 col-sm-6 highlight">
					<div class="h-caption">
						<h4>
							<i class="fa fa-flash fa-5"></i>Diagnose
						</h4>
					</div>
					<div class="h-body text-center">
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
				...
				<div class="col-md-3 col-sm-6 highlight">
					<div class="h-caption">
						<h4>
							<i class="fa fa-heart fa-5"></i>Appointment
						</h4>
					</div>
					<div class="h-body text-center">
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
				...
				<div class="col-md-3 col-sm-6 highlight">
					<div class="h-caption">
						<h4>
							<i class="glyphicon-floppy-disk"></i>Appointment Type
						</h4>
					</div>
					<div class="h-body text-center">
						<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
