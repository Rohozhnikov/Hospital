...
<title>About - Progressus Bootstrap template</title>
	<jsp:include page="/WEB-INF/view/default/headLink.jsp" />

</head>

<body>
	<!-- Fixed navbar -->
		<jsp:include page="/WEB-INF/view/default/header.jsp" />
	...
	<div class="container">
		...
		<div class="row">
			...
			<article class="col-sm-8 maincontent">
				...
				<h3>Lorem ipsum</h3>
				<p>
					<img src="assets/images/mac.jpg" alt=""
				...
				<p>Velit, odit, eius, libero unde impedit quaerat dolorem
					...
					aspernatur labore quibusdam dolore corrupti quod inventore.
					Maiores, repellat, consequuntur eius repellendus eos aliquid
			...
			<aside class="col-sm-4 sidebar sidebar-right">
				...
				<div class="widget">
					...
					<ul class="list-unstyled list-spaces">
						...
						<span class="small text-muted">Reprehenderit illum quod
								unde quo vero ab inventore alias veritatis.</span></li>
	...
	<jsp:include page="/WEB-INF/view/default/footer.jsp" />
